        ...
        <section class="wrapper">
            <form action="#" method="post" id="form_inscription" class="etape1" novalidate>
				<div class="form_promo border10">
					<a href="#bloc_mentions" class="macaron"><span>20 &euro;</span> <b>OFFERTS</b> pour pr&ecirc;ter !</a>
				</div>
                <div id="form_header">
                ...
                <div class="form_content etape2">
                    ...
                    <div class="cb-holder">
                        ...
                        <p id="label_inscription_cgv">J'ai lu et j'accepte les <a href="https://www.unilend.fr/cgu-preteur-individual-1" target="_blank">Conditions G&eacute;n&eacute;rales de Vente</a> d'Unilend</p>
    ...
    <div id="home" class="wrapper100">
        <section class="wrapper">
			...
			<div class="w_1 bloc_mac">
				...
				<!--<div class="disp_4">
					<h2 class="titre_1">Recevez chaque mois vos int&eacute;r&ecirc;ts</h2>
				</div>-->
			</div>
            ...
            <ul>
                <li>
                    ...
                    <p>
                        ...
                        Leur capacit&eacute; de remboursement a &eacute;t&eacute; soigneusement &eacute;tudi&eacute;e. 
                    </p>
                </li>
                <li>
                    <h3><span>2</span> PR&ecirc;TEZ &agrave; PARTIR DE 20&euro;</h3>
                    <p>
                        Choisissez le montant (&agrave; partir de 20&euro;) et le taux (entre 4% et 10%)<br/>
            ...
            <div class="mentions">
            	Offre valable jusqu&apos;au 28/02/2015 r&eacute;serv&eacute;e aux personnes physiques, capables, majeures.

L&apos;offre est r&eacute;serv&eacute;e aux nouveaux inscrits dont l&apos;inscription est valid&eacute;e par Unilend. Seules les personnes physiques de nationalit&eacute; fran&ccedil;aise, ou poss&eacute;dant une nationalit&eacute; d&apos;un pays de l&apos;Espace Economique Europ&eacute;en, et disposant d&apos;un compte bancaire en euros en France pourront b&eacute;n&eacute;ficier de l&apos;offre.

Les 20&euro; seront vers&eacute;s sur le compte Unilend du client dans le mois suivant la validation du compte et ne pourront servir qu&apos;&agrave; pr&ecirc;ter sur Unilend. Le client pourra pr&ecirc;ter cette somme &agrave; l&apos;entreprise de son choix parmi les entreprises pr&eacute;sent&eacute;es sur le site et ce dans un d&eacute;lai de 3 mois suivant la validation de son inscription. En cas de non utilisation de cette somme dans ce d&eacute;lai pour un pr&ecirc;t, Unilend se r&eacute;serve le droit de reprendre ce montant non utilis&eacute;.

Une seule prime de 20&euro; par personne et par compte Unilend est octroy&eacute;e. Offre non cumulable avec toute offre commerciale ou de parrainage en cours. Cette offre est r&eacute;gie par la loi fran&ccedil;aise.

Voil&agrave;, c&apos;est tout. Si vous avez lu jusqu&apos;ici, il ne vous reste plus qu&apos;&agrave; tester !
            </div>
    ...
    <div id="pourquoi_unilend" class="wrapper100 bg_gris">
        <section class="wrapper">
            ...
            <ul>
                ...
                <li>Faites travaillez votre argent dans les PME fran&ccedil;aises</li>
            </ul>
    ...
    <div id="simulez_vos_interets" class="wrapper100">
        <section class="wrapper">
            <a href="#" id="logo"><img src="img/unilend.png" alt="Unilend - Vos int&eacute;r&ecirc;ts se rencontrent" width="252" height="60"></a>
            <h1>Simulez <span>vos int&eacute;r&ecirc;ts</span></h1>

            <section id="pret">
                <h1>Vous pr&ecirc;tez</h1>
                <div id="pret_left">
                    <div>
                        <p>La somme de</p>
                ...
                <div id="pret_right">
                    <p>Dur&eacute;e du pr&ecirc;t</p>
            ...
            <section id="recu">
                <div>
                    ...
                    <div id="recu_result">
                        <p>
                            Soit <span><span>217,40</span> &euro;</span><br/>
                            <span>d'int&eacute;r&ecirc;ts bruts</span>
                        </p>
                        <p>=</p>
                        <p>
                            <span>21,74</span><br/>
                            du montant pr&ecirc;t&eacute;
                        </p>
                        <div class="clear"></div>
                    </div>
                </div>
            ...
            <p class="fleche">Inscrivez-vous et commencez &agrave; pr&ecirc;ter en quelques clics</p>
    ...
    <div id="presse" class="wrapper100">
        <section class="wrapper">
            ...
            <!-- <a id="video" href="http://video.lefigaro.fr/figaro/video/unilend-est-une-alternative-aux-banques-nicolas-lesur-dans-gmb/3026157026001/" target="_blank"><img src="img/video.jpg" alt="Vid&eacute;o - Le Figaro - Unilend est une alternative aux banques" width="354" height="200"></a> -->
            ...
            <div class="clear"></div>
            <p class="fleche">Inscrivez-vous et d&eacute;couvrez l&apos;efficacit&eacute; d&apos;Unilend pour investir votre argent</p>
