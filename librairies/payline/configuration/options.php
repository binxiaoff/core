...
define('CONTRACT_NUMBER', '4543015'); // Contract type default (ex: 001 = CB, 003 = American Express...)
define('CONTRACT_NUMBER_LIST', '4543015'); // Contract type multiple values (separator: ;)
