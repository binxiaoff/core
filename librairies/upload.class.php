...
class upload {
	...
	private $ext_valides = array('jpeg','JPEG','jpg','JPG','png','PNG','gif','GIF','pdf','PDF','doc','DOC','xls','XLS','ppt','PPT','csv','CSV','swf','SWF','pptx','PPTX','docx','DOCX','xlsx','XLSX','TXT','txt','TIFF','tiff');
