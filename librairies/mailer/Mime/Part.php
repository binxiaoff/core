...
namespace Unilend\librairies\Mailer\Mime;

use Unilend\librairies\Mailer\Mime;
use Exception;
...
class Part
{
     ...
     *
     * @param mixed $subpart Peut être un objet \Unilend\librairies\Mailer\Mime\Part, un tableau
     *                       d’objets \Unilend\librairies\Mailer\Mime\Part, ou simplement une chaîne
     */
