...
class loans extends loans_crud
{
    ...
    public function getSumLoansByProject(int $idLender, $order = null, $year = null, $includePendingBids = false): array
    {
        ...
        $statement = $this->bdd->executeQuery($query, [
                ...
                'fundedStatus'  => [ProjectsStatus::STATUS_PUBLISHED, ProjectsStatus::STATUS_FUNDED],
                'idLender'      => $idLender,
                'year'          => $year
            ], [
    ...
    public function sumLoansByCohort($groupFirstYears = true)
    {
        ...
        $query = 'SELECT SUM(loans.amount)/100 AS amount,
                    ...
                    FROM loans
                      INNER JOIN projects on loans.id_project = projects.id_project AND projects.status >= ' . ProjectsStatus::STATUS_CONTRACTS_SIGNED . '
                    GROUP BY cohort';
