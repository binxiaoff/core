...
class projects extends projects_crud
{
    ...
    private function getSaleProjectsQuery(array $status)
    {
        return $this->bdd->createQueryBuilder()
            ...
            ->setParameter('eulerScoringType', \Unilend\Bundle\CoreBusinessBundle\Entity\CompanyRating::TYPE_EULER_HERMES_GRADE)
            ->setParameter('altaresScoringType', \Unilend\Bundle\CoreBusinessBundle\Entity\CompanyRating::TYPE_ALTARES_SCORE_20)
            ->setParameter('infolegaleScoringType', \Unilend\Bundle\CoreBusinessBundle\Entity\CompanyRating::TYPE_INFOLEGALE_SCORE)
