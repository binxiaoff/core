...
namespace KLS\Test\Syndication\Agency\Unit\Service\Jwt;

use Exception;
use KLS\Core\Entity\Company;
use KLS\Core\Entity\Staff;
use KLS\Core\Entity\User;
use KLS\Syndication\Agency\Service\Jwt\PermissionProvider;
use PHPUnit\Framework\TestCase;

/**
 * @coversDefaultClass \KLS\Syndication\Agency\Service\Jwt\PermissionProvider
 *
 * @internal
 */
class PermissionProviderTest extends TestCase
{
    ...
    public function testGetServiceName(): void
    {
        ...
        static::assertSame('agency', $permissionProvider->getServiceName());
    }
