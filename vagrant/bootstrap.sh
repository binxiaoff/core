...
then
    ...
    mysql -uroot -pROOTPASSWORD unilend -e "INSERT INTO users (id_user_type, firstname, name, phone, mobile, email, password, password_edited, id_tree, status, default_analyst, added, updated, lastlogin) VALUES ('1', 'Dev', 'Admin', '', '', 'devadmin@unilend.fr', MD5('devadmin'), NOW(), '0', '2', '0', NOW(), NOW(), NOW())"
fi
