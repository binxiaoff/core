...
class emprunteursController extends bootstrap
{
	...
	function _gestion()
	{
		...
		{
			if($_POST['status'] == 'choisir')$statut = '';
			else $statut = $_POST['status'];
		...
		if(isset($_POST['form_add_emprunteur']))
		{
			...
			if(isset($_FILES['cni_passeport']) && $_FILES['cni_passeport']['name'] != '')
			{
				...
				{
					if($this->clients->cni_passeport != '')@unlink($this->path.'protected/clients/cni_passeport/'.$this->clients->cni_passeport);
			...
			if(isset($_FILES['signature']) && $_FILES['signature']['name'] != '')
			{
				...
				{
					if($this->clients->signature != '')@unlink($this->path.'protected/clients/signature/'.$this->clients->signature);
