            ...
            <table class="formColor">
                <tr>
                    <td>
                        ...
                        <textarea style="width:500px;height:300px;" name="content_email_completude" id="content_email_completude"><?= $text = str_replace(["<br>", "<br />"], "", $_SESSION['content_email_completude'][$this->params[0]]) ?></textarea>
                    </td>
                </tr>
                <tr>
                    <th>
...
<script type="text/javascript">
    $("#previsualisation").click(function() {
        $.post(add_url + "/ajax/session_content_email_completude", {
            ...
            content: $("#content_email_completude").val()
        }).done(function (data) {
            if (data != 'nok') {
