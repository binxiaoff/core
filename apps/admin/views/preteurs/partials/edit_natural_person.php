 <div class="row">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <input type="text" name="naissance" class="form-control" value="<?= null !== $this->client->getNaissance() ? $this->client->getNaissance()->format('d/m/Y') : '' ?>"/>
            </div>
            <div class="form-group col-md-3">
    ...
    <?php endif; ?>
    <div class="col-md-12">
        <h3 class="meme-adresse" <?= ($this->samePostalAddress ? 'style="display:none;"' : '') ?>>Adresse postale</h3>
