            ...
            <tbody>
                <?php foreach ($this->aLenders as $i => $aLender) : ?>
                    ...
                    <tr id="edit_lenders_<?= $aLender['id_adresse'] ?>" style="display: none">
                        <td colspan="3">
                            <label for="cp_<?= $aLender['id_adresse'] ?>">Code postal :</label>
                            <input type="text" class="input_large" name="cp" id="cp_<?= $aLender['id_adresse'] ?>" data-autocomplete="post_code">
                        </td>
                        <td colspan="3">
                            <label for="city_<?= $aLender['id_adresse'] ?>">Ville :</label>
                            <input type="text" class="input_large" name="city" id="city_<?= $aLender['id_adresse'] ?>" data-autocomplete="city">
                        </td>
                        ...
                        <td>
                            <a href="#" class="save_lender btn_link" data-adresseId="<?= $aLender['id_adresse'] ?>">Sauvegarder</a>
                        </td>
                        <td>
                            <a href="#" class="close_edit btn_link" data-adresseId="<?= $aLender['id_adresse'] ?>">Fermer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
