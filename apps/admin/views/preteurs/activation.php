            ...
            <tbody>
                ...
                <?php foreach ($this->lPreteurs as $client) : ?>
                    <?php
                        ...
                        } elseif (in_array($client['clients_status'], [ClientsStatus::STATUS_TO_BE_CHECKED, ClientsStatus::STATUS_COMPLETENESS_REPLY, ClientsStatus::STATUS_MODIFICATION])) {
                    ...
                    <tr class="<?= ($iRow % 2 == 1 ? '' : 'odd') ?> ">
                        ...
                        <td align="center">
                            <?php if (in_array($client['clients_status'], [ClientsStatus::STATUS_TO_BE_CHECKED, ClientsStatus::STATUS_COMPLETENESS_REPLY, ClientsStatus::STATUS_MODIFICATION])) : ?>
