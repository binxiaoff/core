...
<div id="contenu">
	...
	<table class="form" style="margin: auto;">
        ...
        <tr class="particulier">
            ...
            <td><input id="exonere" type="radio" <?=($this->lenders_accounts->exonere==1?'checked':'')?> name="exonere" value="1">Oui 
            <?
			if($this->lenders_accounts->exonere==0)
			{
            	?><input id="exonere2" type="radio" <?=($this->lenders_accounts->exonere==0?'checked':'')?> name="exonere" value="0">Non</td><?
			}
			?>
        </tr>
        <?
        ...
        <tr class="societe">
            ...
            <td>
            <select name="form-juridique" id="form-juridique" class="select">
    ...
    <table class="form" style="width: auto;">
        ...
        <tr>
        	<th>Autre :</th>
            <td><a href="<?=$this->lurl?>/protected/autre_lender/<?=$this->lenders_accounts->fichier_autre?>"><?=$this->lenders_accounts->fichier_autre?></a></td>
            <td><input type="file" name="fichier7"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="file" name="fichier6"></td>
        </tr>
        <tr>
        	<th>Mandat :</th>
            <td>
			...
			{
				?><a href="<?=$this->lurl?>/protected/mandat_preteur/<?=$this->clients_mandats->name?>"><?=$this->clients_mandats->name?></a></td><?
			}
			?>
