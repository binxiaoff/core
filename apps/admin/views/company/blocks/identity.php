    <form method="post" name="edit_company" id="edit_company" enctype="multipart/form-data" action="<?= $this->url ?>/company/add">
        <table class="formColor" style="width: 775px;margin:auto;">
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" name="bic" id="bic" required class="input_large"></td>
            </tr>--->
            <tr>
                <th><label for="rib">RIB*</label></th>
                <td colspan="3"><input type="file" name="rib" id="rib" required></td>
            </tr>
            <tr>
                <th><label for="kbis">KBIS</label></th>
                <td colspan="3"><input type="file" name="kbis" id="kbis"></td>
            </tr>
            <tr>
                <th colspan="4">
