							...
							<tr>
								...
								if(strpos($t['montant'],'-') === false)
								{
									...
									if($t['type_transaction'] == 5)
									{
										...
										?>
                                        <td style="vertical-align:top;"><?=$this->ficelle->formatNumber(($t['montant']/100)+$retenuefiscale)?> &euro;</td>
                                        <td style="vertical-align:bottom;"><?=$this->ficelle->formatNumber('-'.$retenuefiscale)?> &euro;</td>
                                        <?
