...
<div id="contenu">
    <ul class="breadcrumbs">
        ...
        <li>Détails d'un client</li>
    </ul>
    <h1>Liste des commandes de <?= $this->clients->prenom . ' ' . $this->clients->nom ?></h1>
    <?php if (count($this->lCommandes) > 0) { ?>
        <table class="tablesorter">
            ...
            foreach ($this->lCommandes as $cmd) {
                ...
                <tr<?= ($i % 2 == 1 ? '' : ' class="odd"') ?>>
                    ...
                    <td align="center"><?= $this->ficelle->formatNumber($cmd['montant'] / 100) ?> €</td>
                    <td align="center"><?= $etat ?></td>
                    <td align="center">
                        <a href="<?= $this->lurl ?>/clients/detailsCommande/<?= $cmd['id_transaction'] ?>" class="thickbox">
