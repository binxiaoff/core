...
<div id="contenu">
	<ul class="breadcrumbs">
        ...
        <?
		if($this->tree->arbo == 1) echo ' <li><a href="'.$this->lurl.'/preteur" title="Arbo prêteur">Arbo prêteur</a> -</li>';
		elseif($this->tree->arbo == 2) echo ' <li><a href="'.$this->lurl.'/emprunteur" title="Arbo emprunteur">Arbo emprunteur</a> -</li>';
		else echo ' <li><a href="'.$this->lurl.'/tree" title="Arborescence">Arborescence</a> -</li>';
		?>
        	...
        	<div id="langue_<?=$key?>"<?=(isset($this->params[2])&&$this->params[2]!=''?($this->params[1]!=$key?' style="display:none;"':''):($key!=$this->dLanguage?' style="display:none;"':''))?>>
                <fieldset>
                    ...
                    <table class="form">
                        ...
                        if($this->tree->video != '')
                        {
                            list($width,$height) = @getimagesize($this->surl.'/var/videos/'.$this->tree->img_menu);
                        ?>
