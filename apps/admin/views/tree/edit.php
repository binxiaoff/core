...
<div id="contenu">
    <ul class="breadcrumbs">
        ...
        <?php if ($this->tree->arbo == 1) : ?>
            <li><a href="<?= $this->lurl ?>/preteur" title="Arbo prêteur">Arbo prêteur</a> -</li>
        <?php elseif ($this->tree->arbo == 2) : ?>
            <li><a href="<?= $this->lurl ?>/emprunteur" title="Arbo emprunteur">Arbo emprunteur</a> -</li>
        <?php else : ?>
