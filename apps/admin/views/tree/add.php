                    ...
                    <div class="gauche">
                        ...
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="title_<?= $key ?>" id="title_<?= $key ?>" class="input_large"/>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="menu_title_<?= $key ?>">Titre du menu :</label></th>
                                <td>
                                    <input type="text" name="menu_title_<?= $key ?>" id="menu_title_<?= $key ?>" class="input_large"/>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="slug_<?= $key ?>">Lien permanent :</label></th>
                                <td>
                                    <input type="text" name="slug_<?= $key ?>" id="slug_<?= $key ?>" class="input_large"/>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="droite">
                        ...
                        <table class="form">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="meta_title_<?= $key ?>" id="meta_title_<?= $key ?>" class="input_large"/>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="meta_description_<?= $key ?>">Description :</label></th>
                                <td>
                                    <textarea name="meta_description_<?= $key ?>" id="meta_description_<?= $key ?>" class="textarea"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="meta_keywords_<?= $key ?>">Mots clés :</label></th>
                                <td>
                                    <textarea name="meta_keywords_<?= $key ?>" id="meta_keywords_<?= $key ?>" class="textarea"></textarea>
                                </td>
                            </tr>
                            <tr>
