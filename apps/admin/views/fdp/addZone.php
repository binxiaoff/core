<div id="popup">
	...
	<form method="post" name="add_zone" id="add_zone" enctype="multipart/form-data" action="<?=$this->lurl?>/fdp" target="_parent">
        <h1>Ajouter une zone et un premier montant</h1>            
        <fieldset>
        	<table class="formColor">
            	<tr>
                	<th><label for="id_zone_aff">ID Zone :</label></td>
                    <td>
                    	<input type="text" name="id_zone_aff" id="id_zone_aff" value="<?=$this->fdp->recupLastId()?>" disabled="disabled" class="input_court" />
                        <input type="hidden" name="id_zone" id="id_zone" value="<?=$this->fdp->recupLastId()?>" />
                   	</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                	<th>
                        <input type="hidden" name="form_add_zone" id="form_add_zone" />
