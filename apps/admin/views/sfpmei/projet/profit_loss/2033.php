            ...
            <tr>
                ...
                foreach ($this->incomeStatements as $incomeStatement) {
                    if (\company_tax_form_type::FORM_2033 != $incomeStatement['form_type']) {
                        ...
                        <?php endif; ?>
                        <td><?= empty($incomeStatement['details'][$label]) ? '-' : $this->ficelle->formatNumber($incomeStatement['details'][$label], 0) . ' €' ?></td>
            ...
            <tr>
                ...
                foreach ($balanceIds as $balanceId):
                    ...
                    if (false !== $index) :
                        ...
                        <?php endif; ?>
                        <td><?= empty($aAssetsDebts[$sFieldName]) ? '-' : $this->ficelle->formatNumber($aAssetsDebts[$sFieldName], 0) . ' €' ?></td>
