...
<div id="contenu">
	<ul class="breadcrumbs">
        ...
        <li>Requete Données financières emprunteurs</li>
    </ul>
	<h1>Requete Données financières emprunteurs</h1>
    
    <div style="margin-bottom:20px; float:right;"><a href="<?=$this->lurl?>/stats/requete_donnees_financieres_csv" class="btn_link">Recuperation du CSV</a></div>
    <?
