    ...
    <table border="0" cellspacing="0" cellpadding="10" width="100%" style="border: 1px solid #00675F;">
    	...
    	<tr>
        	<td align="center">            	
				...
				{
				?>
                	<a href="<?=$this->lurl?>/commandes/aCommande/<?=$this->transactions->id_transaction?>" title="ANNULER LA COMMANDE" onClick="return confirm('Etes vous sur de vouloir annuler cette commande ?');" style="text-decoration:underline">
