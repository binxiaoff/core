...
<div id="contenu">
	<ul class="breadcrumbs">
        ...
        <li>Rechercher commandes</li>
    </ul>
	<h1>Liste des commandes pour cette recherche</h1>
    <?
	...
	?>
    	<table class="tablesorter">
			...
			?>
            	<tr<?=($i%2 == 1?'':' class="odd"')?>>
                    <td align="center"><?=$this->dates->formatDate($cmd['date_transaction'],'d/mY')?></td>
    ...
    {
    ?>
        <p>Il n'y a aucune commande pour cette recherche.</p>
    <?
    }
    ?>
</div>
