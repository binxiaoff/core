<div id="popup">
    ...
    <form method="post" name="edit_templates" id="edit_templates" enctype="multipart/form-data" action="<?=$this->lurl?>/templates/<?=$this->templates->id_template?>" target="_parent">
