...
<div id="contenu">
    ...
    <div class="btnDroite"><a href="<?=$this->lurl?>/templates/add" class="btn_link thickbox">Ajouter un template</a></div>
	<?
            	...
            	<tr<?=($i%2 == 1?'':' class="odd"')?>>
                    ...
                    <td>
						...
						?>
							...
							{
							?>
								[<a href="<?=$this->lurl?>/templates/edition/<?=$t['slug']?>" title="Editer le fichier">Edition</a>]
                          	<?
							}
							?>
                       	<?
