<div id="popup">
    ...
    <form method="post" name="add_bloc" id="add_bloc" enctype="multipart/form-data" action="<?= $this->lurl ?>/templates/elements" target="_parent">
                ...
                <tr>
                    ...
                    <td>
                        <select name="id_bloc" id="id_bloc" class="select">
                            ...
                            <?php foreach($this->lBlocsOnline as $blocs) : ?>
                                <option value="<?= $blocs['id_bloc'] ?>"><?= $blocs['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </td>
                </tr>
