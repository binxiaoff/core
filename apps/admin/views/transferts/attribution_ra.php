...
<div id="popup">
    ...
    <div id="leformpreteur">
        <form method="post" name="search_projet" id="search_preteur" enctype="multipart/form-data" action="<?= $this->lurl ?>/transferts/virements_ra" target="_parent">
...
<script type="text/javascript">
    ...
    $("#send_preteur").click(function () {
        ...
        $.post(add_url + '/ajax/attribution_ra', val).done(function (data) {
            //alert(data);
