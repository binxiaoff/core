<div id="popup">
    ...
    <form method="post" name="edit_type" id="edit_type" enctype="multipart/form-data" action="<?= $this->lurl ?>/campagnes/types/<?= $this->partenaires_types->id_type ?>" target="_parent">
