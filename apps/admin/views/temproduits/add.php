<div id="popup">
    ...
    <form method="post" name="add_template" id="add_template" enctype="multipart/form-data" action="<?=$this->lurl?>/temproduits" target="_parent">
        <h1>Ajouter un template produit</h1>
        <fieldset>
