...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#date_pub").datepicker({
				...
				changeMonth: true,
				changeYear: true,
				minDate: new Date(<?=date('Y')?>, <?=date('m')-1?>, <?=(date('d')+1)?>)
		});
                ...
                <table class="form" style="width: 538px;">
                    ...
                    <tr class="content_date_publicaion" <?=($this->current_projects_status->status >= 35?'':'style="display:none"')?>>
                        ...
                        <td id="date_publication">
                            ...
                            {
                                echo $this->dates->formatDate($this->projects->date_publication,'d/m/Y');
                            }
                            ?>
                        </td>
                    </tr>
                    ...
                    <tr class="content_date_retrait" <?=($this->current_projects_status->status >= 35?'':'style="display:none"')?>>
                        ...
                        <td id="date_retrait">
                            ...
                            { 
                                echo $this->dates->formatDate($this->projects->date_retrait,'d/m/Y');
                            }
                            ?>
                        </td>
                    </tr>
