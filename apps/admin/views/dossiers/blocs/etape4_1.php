...
<div class="tab_content<?php if ($this->projects->status == ProjectsStatus::STATUS_REQUESTED && $isRiskUser) : ?> expand<?php endif; ?>" id="etape4_1">
                ...
                <tr>
                    ...
                    <td>
                        <?php if (false === empty($this->ratings['score_sectoriel_altares']['value'])) : ?>
                            <span class="rating-tooltip" title="score_sectoriel_altares"><?= $this->ratings['score_sectoriel_altares']['value'] ?> / 20</span>
                        <?php else : ?>-<?php endif; ?>
                    </td>
                    <?php if (isset($this->targetRatings)) : ?>
                        <td>
                            <?php if (false === empty($this->targetRatings['score_sectoriel_altares']['value'])) : ?>
                                <span class="rating-tooltip" title="target_score_sectoriel_altares"><?= $this->targetRatings['score_sectoriel_altares']['value'] ?> / 20</span>
                            <?php else : ?>-<?php endif; ?>
                        </td>
                    <?php endif; ?>
                </tr>
