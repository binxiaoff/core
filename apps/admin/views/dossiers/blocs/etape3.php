...
<div class="tab_content<?php if ($this->projects->status == ProjectsStatus::PREP_FUNDING && UsersTypes::TYPE_COMMERCIAL == $_SESSION['user']['id_user_type']) : ?> expand<?php endif; ?>" id="etape3">
