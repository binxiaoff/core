                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (
                                ...
                                <a href="<?= $this->lurl ?>/thickbox/project_rejection_reason/<?= $this->projects->id_project ?>" title="Modifier le motif de rejet" class="thickbox"><img src="<?= $this->surl ?>/images/admin/edit.png" alt="Modifier le motif de rejet"/></a>
                            <?php endif; ?>
