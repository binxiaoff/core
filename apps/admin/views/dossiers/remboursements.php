...
<div id="contenu">
	...
	{
		?><h1>Résultats de la recherche des remboursements <?=(count($this->lProjects)>0?'('.count($this->lProjects).')':'')?></h1><?
	}
	else
	{
    ...
    <form method="post" name="search_remb" id="search_remb" enctype="multipart/form-data" action="<?=$this->lurl?>/dossiers/remboursements" target="_parent">
        <fieldset>
