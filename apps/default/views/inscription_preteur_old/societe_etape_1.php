<form action="" method="post" id="form_inscription_preteur_societe_etape_1" name="form_inscription_preteur_societe_etape_1">
    <div class="part_societe1">
                    ...
                    <div class="row rel">
                        ...
                        <input type="text" name="siren_inscription" id="siren_inscription" title="<?=$this->lng['etape1']['siren']?>" value="<?=($this->companies->siren!=''?$this->companies->siren:$this->lng['etape1']['siren'])?>" data-validators="Presence&amp;Numericality&amp;Length, {minimum: 9, maximum: 9}" class="field field-large required">
                    </div><!-- /.row -->
                    <div class="row">
    ...
    <div class="les_deux">
        ...
        <div class="row row-triple-fields">
            ...
            <input type="text" name="postalE" id="postalE" data-autocomplete="postCodes" title="<?=$this->lng['etape1']['code-postal']?>" value="<?=($this->companies->zip!=0?$this->companies->zip:$this->lng['etape1']['code-postal'])?>"  class="field field-small required" data-validators="Presence&amp;Numericality&amp;Length, {is: 5}">
        ...
        <div class="row">
            ...
            <div class="addr_correspondance">
                ...
                <div class="row row-triple-fields">
                    ...
                    <input type="text" id="postal2E" name="postal2E" data-autocomplete="postCodes" value="<?=($this->clients_adresses->cp!=0?$this->clients_adresses->cp:$this->lng['etape1']['code-postal'])?>" title="<?=$this->lng['etape1']['code-postal']?>" class="field field-small required" data-validators="Presence&amp;Numericality&amp;Length, {is: 5}">
            ...
            <div class="part_societe2">
                    ...
                    <div class="add-new-profile">
                        ...
                        <div class="row">
                             ...
                             <input type="text" name="email_inscription" title="<?=$this->lng['etape1']['email']?>" value="<?=($this->clients->email?$this->clients->email:$this->lng['etape1']['email'])?>" id="email_inscription" class="field field-large required" data-validators="Presence&amp;Email" onkeyup="checkConf(this.value,'conf_email_inscription')">
                             
                             <input type="text" name="conf_email_inscription" title="<?=$this->lng['etape1']['confirmation-email']?>" value="<?=($this->clients->email?$this->clients->email:$this->lng['etape1']['confirmation-email'])?>" id="conf_email_inscription" class="field field-large required" data-validators="Confirmation,{ match: 'email_inscription' }">
                        </div><!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <input type="text" id="secret-questionE" name="secret-questionE" title="<?=$this->lng['etape1']['question-secrete']?>" value="<?=($this->clients->secrete_question!=''?$this->clients->secrete_question:$this->lng['etape1']['question-secrete'])?>" class="field field-mega required" data-validators="Presence">
                        </div><!-- /.row -->
                        ...
                        <!-- fin partie mot de passe societe -->
                        <?
						}
						?>
    ...
    <div class="row">
        <div class="cb-holder">
            <label class="check-societe" for="accept-cgu-societe"><a style="color:#A1A5A7; text-decoration: underline;" class="check-societe" target="_blank" href="<?=$this->lurl.'/'.$this->tree->getSlug($this->lienConditionsGeneralesSociete,$this->language)?>"><?=$this->lng['etape3']['jaccepte-les-cgu-dunilend']?></a></label>
    ...
    <div class="form-foot row row-cols centered">
        ...
        <button class="btn" onClick="$('#form_inscription_preteur_societe_etape_1').submit();" type="submit"><?=$this->lng['etape1']['suivant']?><i class="icon-arrow-next"></i></button>
