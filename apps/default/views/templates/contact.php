        ...
        <div class="contact">
            ...
            <div class="contact-form">
                <form action="" method="post">
                    ...
                    <div class="row" <?= ($this->demande_contact->demande == 5 ? 'style="display:block;"' : 'style="display:none;"') ?> id="rowPreciser">
                        <input type="text" title="<?= $this->lng['contact']['preciser'] ?>" name="preciser" value="<?= empty($this->demande_contact->preciser) ? $this->lng['contact']['preciser'] : $this->demande_contact->preciser ?>" id="preciser" class="field field-small">
                    </div><!-- /.row -->

                    <div class="row">
                        <input type="text" title="<?= $this->lng['contact']['nom'] ?>" value="<?= empty($this->demande_contact->nom) ? $this->lng['contact']['nom'] : $this->demande_contact->nom ?>" id="nom" name="nom" class="field field-small required <?= (isset($this->error_nom) && $this->error_nom == 'ok' ? 'LV_valid_field' : (isset($this->error_nom) && $this->error_nom == 'nok' ? 'LV_invalid_field' : '')) ?>" data-validators="Presence">
                        <input type="text" title="<?= $this->lng['contact']['prenom'] ?>" value="<?= empty($this->demande_contact->prenom) ? $this->lng['contact']['prenom'] : $this->demande_contact->prenom ?>" name="prenom" id="prenom" class="field field-small required <?= (isset($this->error_prenom) && $this->error_prenom == 'ok' ? 'LV_valid_field' : (isset($this->error_prenom) && $this->error_prenom == 'nok' ? 'LV_invalid_field' : '')) ?>" data-validators="Presence">
                    </div><!-- /.row -->

                    <div class="row">
                        <input type="text" title="<?= $this->lng['contact']['email'] ?>" value="<?= empty($this->demande_contact->email) ? $this->lng['contact']['email'] : $this->demande_contact->email ?>" name="email" id="email" class="field field-small required <?= (isset($this->error_email) && $this->error_email == 'ok' ? 'LV_valid_field' : (isset($this->error_email) && $this->error_email == 'nok' ? 'LV_invalid_field' : '')) ?>" data-validators="Email">
                        <input type="text" title="<?= $this->lng['contact']['telephone'] ?>" value="<?= empty($this->demande_contact->telephone) ? $this->lng['contact']['telephone'] : $this->demande_contact->telephone ?>" name="telephone" id="phone" class="field field-small <?= (isset($this->error_telephone) && $this->error_telephone == 'ok' ? 'LV_valid_field' : (isset($this->error_telephone) && $this->error_telephone == 'nok' ? 'LV_invalid_field' : '')) ?>">
                    </div><!-- /.row -->

                    <div class="row">
                        <input type="text" title="<?= $this->lng['contact']['societe'] ?>" value="<?= empty($this->demande_contact->societe) ? $this->lng['contact']['societe'] : $this->demande_contact->societe ?>" name="societe" id="societe" class="field field-small">
                    </div><!-- /.row -->
            ...
            <div class="contact-block">
                <div class="contact-block-body">
                    ...
                    <p>
                        <i class="icon-phone"></i> <?= $this->lng['contact']['bloc-tel'] ?> : <?= $this->content['bloc-telephone'] ?>
                    </p>
