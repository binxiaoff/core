<form action="" method="post" id="form_inscription_preteur_societe_etape_1" name="form_inscription_preteur_societe_etape_1">
    <div class="part_societe1">
                    ...
                    <div class="row rel">
                        ...
                        <?php /*?><input type="text" name="siren_inscription" id="siren_inscription" title="<?=$this->lng['etape1']['siren']?>" value="<?=($this->companies->siren!=''?$this->companies->siren:$this->lng['etape1']['siren'])?>" data-validators="Presence&amp;Numericality&amp;Length, {minimum: 9, maximum: 9}" class="field field-large required"><?php */?>
    ...
    <div class="row">
        <div class="cb-holder">
            ...
            <?php /*?><label class="check-societe" for="accept-cgu-societe"><a style="color:#A1A5A7; text-decoration: underline;" class="check-societe" target="_blank" href="<?=$this->lurl.'/'.$this->tree->getSlug($this->lienConditionsGeneralesSociete,$this->language)?>"><?=$this->lng['etape3']['jaccepte-les-cgu-dunilend']?></a></label><?php */?>
