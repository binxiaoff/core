...
<script type="text/javascript">
    ...
    $("#form_inscription_preteur_particulier_etape_2").submit(function (event) {
        ...
        if ($('#txt_ci').val() == '<?=$this->lng['etape2']['aucun-fichier-selectionne']?>') {
            ...
            $("#txt_ci").removeClass("LV_invalid_field");
            $("#txt_ci").addClass("LV_valid_field");
        }
        ...
        if ($('#txt_justificatif_de_domicile').val() == '<?=$this->lng['etape2']['aucun-fichier-selectionne']?>') {
            ...
            $("#txt_justificatif_de_domicile").removeClass("LV_invalid_field");
            $("#txt_justificatif_de_domicile").addClass("LV_valid_field");
        }
        // rib
        ...
        if ($('#document_fiscal').val() == '<?=$this->lng['etape2']['aucun-fichier-selectionne']?>') {
            ...
            $("#document_fiscal").removeClass("LV_invalid_field");
            $("#document_fiscal").addClass("LV_valid_field");
        }
        <?
    }
    ?>
        ...
        if ($('#origine_des_fonds').val() == '1000000') {
            if ($('#preciser').val() == '' || $('#preciser').val() == $('#preciser').attr('title')) {
                form_ok = false;
                $("#preciser").removeClass("LV_valid_field");
                $("#preciser").addClass("LV_invalid_field");
            }
            else {
                $("#preciser").removeClass("LV_invalid_field");
                $("#preciser").addClass("LV_valid_field");
            }
        }
