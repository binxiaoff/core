<form action="" method="post" id="form_inscription_preteur_particulier_etape_2" enctype="multipart/form-data">
    ...
    <div class="form-foot row row-cols centered">
        ...
        <a class="btn btn-warning" href="<?= $this->lurl ?>/inscription_preteur/etape1/<?= $this->clients->hash ?>"><i class="icon-arrow-prev"></i><?= $this->lng['etape2']['precedent'] ?>
        </a>

        <button id="next_preteur" class="btn" type="submit" onClick="$('#form_inscription_preteur_particulier_etape_2').submit();"><?= $this->lng['etape2']['suivant'] ?>
