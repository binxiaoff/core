...
<div class="pdf-wrapper">
    ...
    <div class="shell">
        ...
        <div class="container">
            ...
            <!-- Case 2 -->
            <div class="case-2">
                <p>En signant ce formulaire de mandat, vous autorisez (A) <em class="big"><?= $this->creancier ?></em> à
                    envoyer des instructions à votre banque pour débiter votre compte, et (B) votre banque à débiter
                    votre compte conformément aux instructions de <em class="big"><?= $this->creancier ?></em>.<br/>
                    Vous bénéficiez du droit d'être remboursé par votre banque selon les conditions décrites dans la
                    convention que vous avez passée avec elle. Une demande de remboursement doit être présentée:<br/>-
                    dans les 8 semaines suivant la date de débit de votre compte pour un prélèvement autorisé,<br/>-
                    sans tarder et au plus tard dans les 13 mois en cas de prélèvement non autorisé.<br/><em>Veuillez
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td class="col-3">
                            ...
                            <div class="row">
                                ...
                                <div
                                    class="text-box"><?= ($this->entreprise == false ? $this->clients->nom . ' ' . $this->clients->prenom : $this->companies->name . ' / SIREN ' . $this->companies->siren) ?></div>
                    ...
                    <tr>
                        ...
                        <td class="col-3">
                            ...
                            <div class="row">
                                <div
                                    class="text-box"><?= ($this->entreprise == false ? $this->clients_adresses->adresse1 : $this->companies->adresse1) ?></div>
                            ...
                            <div class="row">
                                <div class="box box-w-1">
                                    ...
                                    <div
                                        class="text-box"><?= ($this->entreprise == false ? $this->clients_adresses->cp : $this->companies->zip) ?></div>
                                    <span class="small-text">Code postal</span>
                                </div>
                                <div class="box box-w-2">
                                    <span class="star">*</span>
                                    <div
                                        class="text-box"><?= ($this->entreprise == false ? $this->clients_adresses->ville : $this->companies->city) ?></div>
