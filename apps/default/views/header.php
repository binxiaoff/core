                ...
                <div class="login-panel" style="width:525px;">
                    <form action="" method="post" id="form_connect" name="form_connect">
                        <div style="height:30px;">
                            <?
                            // on lance le captcha
                            if (isset($_SESSION['login']['nb_tentatives_precedentes']) && $_SESSION['login']['nb_tentatives_precedentes'] > 5 && ! isset($_POST['project_detail'])) {
                                ?>
                            ...
                            elseif (isset($_SESSION['login']['nb_tentatives_precedentes']) && $_SESSION['login']['nb_tentatives_precedentes'] > 1 && ! isset($_POST['project_detail'])) {
                            ...
                            elseif (isset($this->error_login) && $_SESSION['login']['nb_tentatives_precedentes'] <= 1 && ! isset($_POST['project_detail'])) {
