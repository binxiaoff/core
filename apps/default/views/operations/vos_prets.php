...
.detail-ope .detailLoans, .detail-ope .detailLoans_declaration_creances{display:inline-block; width:100%;border-bottom:1px solid #b10366;}
.detail-ope .detailLoans .borderTop, .detail-ope .detailLoans_declaration_creances .borderTop{border-top:1px solid #b10366;}
.detail-ope .detailLoans .borderBottom, .detail-ope .detailLoans_declaration_creances .borderBottom{border-bottom:1px solid #b10366;}
.detail-ope .detailLoans td, .detail-ope .detailLoans_declaration_creances td{padding-top:3px;padding-bottom:3px;}
.content_declaration_creances td{vertical-align:middle;}
					...
					if(in_array($l['id_project'],$this->arrayDeclarationCreance))
					{
						...
						<tr class="<?=($i%2 == 1?'':'odd')?> content_declaration_creances">
							...
							<td>     
									...
									<a style="font-size: 10px;vertical-align: middle;margin-right: 13px;" class="btn-detailLoans_declaration_creances_<?=$k?> btn-grise btn-warning btn btn-info btn-small multi"><?=$this->lng['preteur-operations-detail']['declaration-de-creances']?></a>
