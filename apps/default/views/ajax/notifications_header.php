    ...
    <?php
        switch ($r['type']) {
            ...
            case \notifications::TYPE_AUTOBID_FIRST_ACTIVATION: ?>
                ...
                <div class="content_notif">
                <?= str_replace(array('[#ACTIVATION_TIME#]','[#LURL#]'), array($this->get('unilend.service.autobid_settings_manager')->getActivationTime($this->clients)->format('G\hi'), $this->lurl), $this->lng['notifications']['content-autobid-activation']) ?>
                </div><?php
                break;
        }
        ?>
