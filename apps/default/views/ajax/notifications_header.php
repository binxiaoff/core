    ...
    <div class="notif <?= ($r['status'] == 1 ? 'view' : '') ?>">
        ...
        if ($r['type'] == 1) {
            ...
            if ($this->bids->amount != $r['amount']) {
                ...
                <b style="color:#b20066;"><?= number_format($r['amount'] / 100) ?> €</b><?= $this->lng['notifications']['offre-refusee-point'] ?>
                </div>
            <?php } else { ?>
        ...
        elseif ($r['type'] == 4) {
            ...
            <div class="content_notif">
                ...
                <b style="color:#b20066;"><?= $this->ficelle->formatNumber($this->loans->rate) ?> %</b> <?= $this->lng['notifications']['offre-acceptee-pour-un-montant-de'] ?>
                <b style="color:#b20066;white-space:nowrap;"><?= number_format($this->loans->amount / 100) ?> €</b> <?= $this->lng['notifications']['offre-acceptee-sur-le-projet'] ?>
