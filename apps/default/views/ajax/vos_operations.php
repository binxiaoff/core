...
//TABLEAU VOS OPERATIONS



$html = '<table class="table vos_operations transactions-history finances" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <th width="200px"  id="order_operations" class="narrow-th '.($this->type == 'order_operations' && $this->order == "asc"?"asc":"").'" style="text-transform: capitalize; font-weight:bold; padding-left: 0px;">         
		...
		<th width="200px"  id="order_bdc" class="narrow-th '.($this->type == 'order_bdc' && $this->order == "asc"?"asc":"").'" style=" font-weight:bold; padding-left: 0px;">         
		...
		<th width="150px" id="order_projects" '.($this->type == 'order_projects' && $this->order == "asc"?'class="asc"':"").' align="center"> 
			<div class="th-wrap">
        ...
        <th width="140px" id="order_date" '.($this->type == 'order_date' && $this->order == "asc"?'class="asc"':"").'>
			<div class="th-wrap">
         ...
         <th width="180px" id="order_montant" '.($this->type == 'order_montant' && $this->order == "asc"?'class="asc"':"").'>
