...
<div class="account-data">
    ...
    <form action="" method="post" id="form_societe_perso" name="form_societe_perso">
        ...
        <div class="les_deux">
            ...
            <div class="row">
                <div class="cb-holder">
                    ...
                    <input type="checkbox" class="custom-input" name="mon-addresse" id="mon-addresse" data-condition="hide:.addr_correspondance" <?=($this->companies->status_adresse_correspondance == 0?'':'checked="checked"')?>>
                </div><!-- /.cb-holder -->
            </div><!-- /.row -->
        ...
        <div class="form-foot row row-cols centered">
            ...
            <button class="btn" onClick="$('#form_societe_perso').submit();" type="button"><?=$this->lng['etape1']['valider']?><i class="icon-arrow-next"></i></button>
