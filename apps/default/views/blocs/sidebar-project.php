                    ...
                    <div class="widget-cat" style="padding-top:25px;">  	
						...
						<script type="text/javascript">
							$( "#seconnecter" ).click(function() {
								...
								else if($(".seconnecteropen").html() == 'false'){ $(".seconnecter").slideDown(); $(".seconnecteropen").html('true'); $("#close-seconnecter").css('background-position','right'); }
								else{ $( "#projectseconnecter" ).submit(); }
							});
							$( "#close-seconnecter" ).click(function() {
								if($(".seconnecteropen").html() == 'true'){ $(".seconnecter").slideUp();$(".seconnecteropen").html('false');$(this).css('background-position','left')}
								else{ $(".seconnecter").slideDown();$(".seconnecteropen").html('true'); $(this).css('background-position','right');} 
							});
						</script>
                    ...
                    <div class="widget-cat" style="padding-top:25px;">
                        ...
                        <script type="text/javascript">
							$( "#sinscrire" ).click(function() {
								if($(".sinscrireopen").html() == 'false'){ $(".sinscrire").slideDown(); $(".sinscrireopen").html('true'); Form.initialise({ selector: 'form' }); $("#close-sinscrire").css('background-position','right'); }
								else{ $( "#projectsinscrire" ).submit(); }
							});
							$( "#close-sinscrire" ).click(function() {
								if($(".sinscrireopen").html() == 'true'){ $(".sinscrire").slideUp();$(".sinscrireopen").html('false');$(this).css('background-position','left');}
								else{ $(".sinscrire").slideDown();$(".sinscrireopen").html('true');$(this).css('background-position','right');} 
							});
