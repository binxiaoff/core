        ...
        <div class="sidebar right">
            <aside class="widget widget-info">
                ...
                <div class="widget-body">
                    <div class="article">
                        <p><?= $this->lng['preteur-projets']['ce-projet-a-ete-totalement-rembourse-le'] ?>
            ...
            <aside class="widget widget-price">
                ...
                <div class="widget-body">
                    <div class="article">
                        ...
                        <p style="padding:8px;"><?= $this->lng['preteur-projets']['periode-denchere-du-projet-terminee'] ?>
                            <br/></p>
                    </div>
                </div>
            </aside>
                        ...
                        <form action="" method="post">
                            ...
                            if ($this->bidsEncours['nbEncours'] > 0) {
                                ...
                                <div class="widget-cat">
                                    ...
                                    <h4 id="plusOffres"><?= $this->lng['preteur-projets']['offre-en-cours'] ?>
                            ...
                            if ($this->clients->status_pre_emp != 2) {
                                ...
                                <div class="widget-cat">
                                        ...
                                        <select name="tx_p" id="tx_p" class="custom-select field-hundred">
                                            ...
                                            if ($this->soldeBid >= $this->projects->amount) {
                                                if (number_format($this->txLenderMax, 1, '.', ' ') > '10.0') {
                                                    ?>
                                                    <option <?= ($this->projects->target_rate == '10.0' ? 'selected' : '') ?> value="10.0">10,0%</option><?php
                                                }
                                                for ($i = 9; $i >= 4; $i--) {
                                                    for ($a = 9; $a >= 0; $a--) {
                                                        if (number_format($this->txLenderMax, 1, '.', ' ') > $i . '.' . $a) {
                                                            ?>
                                                            <option <?= ($this->projects->target_rate == $i . '.' . $a ? 'selected' : '') ?> value="<?= $i . '.' . $a ?>"><?= $i . ',' . $a ?>%</option><?php
                                                        }
                                                    }
                                                }
                                            } else {
                                    ...
                                    <div class="row last-row">
                                        ...
                                        <input name="montant_p" id="montant_p" type="text" title="<?= $this->lng['preteur-projets']['montant-exemple'] ?>" value="<?= $this->lng['preteur-projets']['montant-exemple'] ?>" class="field" onkeyup="lisibilite_nombre(this.value,this.id);"/>
