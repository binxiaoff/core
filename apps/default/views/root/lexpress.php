...
<div class="shell page-landing">
    <div class="container cf">
        <section class="content left">
            <header class="page-header cf">
                <a target="_blank" href="<?= $this->content['lp-lien-logo-247'] ?>" class="logo left">
                    <img src="<?= $this->surl ?>/landing-page/css/images/logo.png">
                </a>
            </header>
            <section class="process">
                ...
                <ul class="cf">
                    <li>
                        <img src="<?= $this->photos->display($this->content['lp-gauche-image-249']) ?>">
                        <p>
                            <strong><?= $this->content['lp-gauche-chiffre-250'] ?></strong>
                            <span><?= $this->content['lp-gauche-texte-251'] ?></span>
                        </p>
                    </li>
                    <li>
                        <img src="<?= $this->photos->display($this->content['lp-centre-image-252']) ?>">
                        <p>
                            <strong><?= $this->content['lp-centre-chiffre-253'] ?></strong>
                            <span><?= $this->content['lp-centre-texte-254'] ?></span>
                        </p>
                    </li>
                    <li>
                        <img src="<?= $this->photos->display($this->content['lp-droite-image-255']) ?>">
                        <p>
                            <strong><?= $this->content['lp-droite-chiffre-256'] ?></strong>
                            <span><?= $this->content['lp-droite-texte-257'] ?></span>
                        </p>
                    </li>
                </ul>
        ...
        <aside class="signup right">
            ...
            <form target="_parent" action="https://www.unilend.fr/lp-depot-de-dossier" method="post" id="depot_de_dossier" name="depot_de_dossier">
