...
<div class="main">
    <div class="shell">
        <div class="section-c clearfix section-single-project">
            ...
            <?php if (isset($_SESSION['messFinEnchere']) && $_SESSION['messFinEnchere']) : ?>
            ...
            <?php elseif (isset($_SESSION['messPretOK']) && $_SESSION['messPretOK']) : ?>
            ...
            <div class="content-col left">
                <div class="project-c">
                    <div class="top clearfix">
                        <a <?= ($this->bIsConnected ? '' : 'style="visibility:hidden;"') ?> class="fav-btn right <?= $this->favori ?>" id="fav" onclick="favori(<?= $this->projects->id_project ?>, 'fav',<?= $this->clients->id_client ?>, 'detail');"><?= ($this->favori == 'active' ? $this->lng['preteur-projets']['retirer-de-mes-favoris'] : $this->lng['preteur-projets']['ajouter-a-mes-favoris']) ?>                            <i></i></a>
                    ...
                    <nav class="tabs-nav">
                        <ul>
                            ...
                            <?php if ($this->projects_status->status == \projects_status::FUNDE || $this->projects_status->status >= \projects_status::REMBOURSEMENT) : ?>
                                <?php if (isset($_SESSION['client']) && $_SESSION['client']['status_pre_emp'] == 1) : ?>
                                    <li>
                                    ...
                                    <table class="table orders-table">
                                        ...
                                        <?php foreach ($this->aBidsOnProject as $iKey => $aBid) : ?>
                                            <?php if ($this->CountEnchere >= 12) : ?>
                                                ...
                                                <?php if ($aBid['ordre'] == 6) : ?>
                                                    <tr>
                                                        <td colspan="4" class="nth-table-row displayAll" style="cursor:pointer;">
                                                            ...
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                ...
                                <?php foreach ($this->aStatusHistory as $aHistory): ?>
                                    <?php if (false === empty($aHistory['site_content'])): ?>
                                        ...
                                        <?php if (1 == $aHistory['failure']): ?>
                                            <p>Vous avez récupéré
                                                <strong class="pinky-span"><?= $this->ficelle->formatNumber($this->sumRemb / $this->bidsvalid['solde'] * 100) ?>
                                                    &nbsp;%</strong> de votre capital.</p>
                                        <?php endif; ?>
                                        <br/><br/>
                                        </p>
                                    <?php endif; ?>
