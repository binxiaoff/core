            ...
            <div class="row">
                ...
                <div class="addr_correspondance">
                    ...
                    <div class="row row-triple-fields">
                        ...
                        <input type="text" id="postal2E" name="postal2E" data-autocomplete="postCodes" value="<?=($this->clients_adresses->cp!=0?$this->clients_adresses->cp:$this->lng['etape1']['code-postal'])?>" title="<?=$this->lng['etape1']['code-postal']?>" class="field field-small required" onBlur="checkCp('ville_inscriptionE',this.id);" onkeyup="checkCp('ville_inscriptionE',this.id);">
