<div class="account-data">
    ...
    <form action="<?=$this->lurl?>/profile/societe/2" method="post" name="form_bank_societe" id="form_bank_societe" enctype="multipart/form-data">
        ...
        <div class="form-foot row row-cols centered">
            ...
            <button id="next_preteur" class="btn" type="button" onClick="$('#form_bank_societe').submit();"><?=$this->lng['etape1']['valider']?><i class="icon-arrow-next"></i></button>
