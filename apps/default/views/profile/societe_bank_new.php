    ...
    <p><?=$this->lng['etape2']['texte-bic-iban']?></p>
            ...
            <div class="uploader">
                ...
                <div class="file-holder">
                    <span class="btn btn-small">
                        ...
                        <span class="file-upload">
                            <input type="file" class="file-field" name="ci_dirigeant" id="file-ci_dirigeant">
                        </span>
                    </span>
                </div>
            </div><!-- /.uploader -->
        ...
        <div class="form-foot row row-cols centered">
            ...
            <button id="next_preteur" class="btn" type="button" onClick="$('#form_societe_perso').submit();"><?=$this->lng['etape1']['valider']?><i class="icon-arrow-next"></i></button>
    
           <?php /*?> <button id="next_preteur" class="btn" type="button" onClick="$('#form_bank_societe').submit();"><?=$this->lng['etape1']['valider']?><i class="icon-arrow-next"></i></button> <?php */?>
	...
	$( "#nom_inscription,#prenom_inscription" ).change(function() {
		...
		if(radio_enterprise == 1){
			if($(this).val() != "<?=$this->clients->nom?>" && change_file_identite == false){ $("#txt_ci_dirigeant").val(''); $(".change_identite").fadeIn();change_txt_identite = true;}
		}
	});
	...
	$( "#file-ci_dirigeant" ).change(function() {
		...
		var radio_enterprise = $('input[type=radio][name=enterprise]:checked').attr('value');
		if(radio_enterprise == 2 || radio_enterprise == 3 ){
			if(change_txt_identite == false){ $( "#nom2_inscription,#prenom2_inscription" ).val(''); $(".change_identite").fadeIn();change_file_identite = true;}
		}
		else{
			if(change_txt_identite == false){ $( "#nom_inscription,#prenom_inscription" ).val(''); $(".change_identite").fadeIn();change_file_identite = true;}
		}
	});
