    ...
    <p><?=$this->lng['etape2']['texte-bic-iban']?></p>
        ...
        <em class="error_fichier" <?= isset($this->error_fichier) && $this->error_fichier ? 'style="display:block;"' : '' ?>><?=$this->lng['etape2']['erreur-fichier']?></em>
        <div class="row row-upload">
            ...
            <div class="uploader">
                <input id="txt_rib" type="text" class="field required <?= isset($this->error_rib) && $this->error_rib ? 'LV_invalid_field' : '' ?>" readonly="readonly" value="<?=($this->attachments[attachment_type::RIB]["path"]!= ''?$this->attachments[attachment_type::RIB]["path"]:$this->lng['etape2']['aucun-fichier-selectionne'])?>" />
