...
{	
	...
	// a mettre en prod apres la gestion des alerte
	...
	function _syntheses_mouvements_old()
	{
		if($this->clients->checkAccess() && isset($_POST['duree']) && in_array($_POST['duree'],array('mois','trimestres','annees')) || 5 == 5){
	...
	function _notifications_header()
	{
		$this->autoFireView = true;
		...
		if(isset($_SESSION['client']['id_client']) && isset($_POST['compteur_notif']) && $_POST['compteur_notif'] != 'noMore'){
			...
			if($_POST['compteur_notif'] != 'true') $_SESSION['nbNotifdisplay'] = $_POST['compteur_notif'];
	...
	{
		$this->autoFireView = true;
		//mail('k1@david.equinoa.net','AJAX1',$_POST['annee']);
		if(/*isset($_POST['tri']) &&*/ isset($_POST['annee']) && strlen($_POST['annee']) == 4 && is_numeric($_POST['annee'])){
