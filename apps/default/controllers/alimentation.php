            ...
            if (is_numeric($amount) && $amount >= 20 && $amount <= 10000) {
                ...
                if (isset($result)) {
                    ...
                    elseif (isset($result)) {
                        ...
                        mail('d.courtier@equinoa.com', 'unilend erreur payline',
                            'alimentation preteur (client : ' . $this->clients->id_client . ') | ERROR : ' . $result['result']['code'] . ' ' . $result['result']['longMessage']);
