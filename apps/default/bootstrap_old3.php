						...
						if($statut_preteur == true)
						{
							...
							// Sinon
								...
								// Sinon
									...
									// On cherche si on a déjà le cgv (si pas signé on redirige sur la page synthese pour qu'il signe)
...
//		}
		...
		elseif($this->lurl == 'http://challenges.unilend.fr'){
			...
			elseif($command->Name == 'ajax'){
				...
				header('location: http://challenges.unilend.fr/challenges/');
				die;
			}
