...
final class Version20211129161105 extends AbstractMigration
{
    public function getDescription(): string
    {
        return '[Core] CALS-3746 Update CGU';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $content = <<<'HTML'
                  ...
                  <section class="article">
                    ...
                    <p>
                      ...
                      la BEI ou la CDC dans le cadre de KLS Credit et Guaranty, (ii) par un Etablissement Client dont il est l’invité, à consulter ou suivre des opérations de crédit qu’elles soient syndiquées dans le cadre du produit KLS Syndication ou qu’elles soient
                      intégrées dans des programmes soutenus par le FEI, la BEI ou la CDC dans le cadre de KLS Credit et Guaranty.
                    </p>
        ...
        $this->addSql("INSERT INTO core_legal_document VALUES (4, 1, 'CGU', '{$content}', {$publicId}, NOW())");
    }

    public function down(Schema $schema): void
    {
        $this->addSql('DELETE FROM core_legal_document WHERE id = 4');
    }
}
