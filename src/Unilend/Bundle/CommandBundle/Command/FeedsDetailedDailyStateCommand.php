...
//        }
    ...
    private function addBalanceLine(\PHPExcel_Worksheet $activeSheet, DetailedDailyStateBalanceHistory $dailyBalances, $row, array $specificRows)
    {
        ...
        $realBalance    = bcadd(bcadd(bcadd($dailyBalances->getLenderBalance(), $dailyBalances->getBorrowerBalance(), 2), bcadd($dailyBalances->getUnilendPromotionalBalance(), $dailyBalances->getUnilendBalance(), 2)), $dailyBalances->getDebtCollectorBalance(), 2);
        ...
        $activeSheet->setCellValueExplicit(self::DEBT_COLLECTOR_BALANCE_COLUMN . $row, $dailyBalances->getBorrowerBalance(), \PHPExcel_Cell_DataType::TYPE_NUMERIC);
