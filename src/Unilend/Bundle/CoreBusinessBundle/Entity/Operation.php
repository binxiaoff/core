...
class Operation
{
    ...
    /**
     * @var \Unilend\Bundle\CoreBusinessBundle\Entity\Sponsorship
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Bundle\CoreBusinessBundle\Entity\Sponsorship")
     * @ORM\JoinColumns({
     ...
     * Set idWelcomeOffer
     *
     * @param \Unilend\Bundle\CoreBusinessBundle\Entity\Sponsorship $idSponsorship
     *
     * @return Operation
     */
    public function setSponsorship(\Unilend\Bundle\CoreBusinessBundle\Entity\Sponsorship $idSponsorship = null)
    {
     ...
     * Get idSponsorship
     *
     * @return \Unilend\Bundle\CoreBusinessBundle\Entity\Sponsorship
     */
