...
class OperationType
{
    ...
    const TAX_TYPES_FR_REGULARIZATION = [
        self::TAX_FR_PRELEVEMENTS_OBLIGATOIRES_REGULARIZATION,
        self::TAX_FR_CSG_REGULARIZATION,
        self::TAX_FR_PRELEVEMENTS_SOCIAUX_REGULARIZATION,
        self::TAX_FR_CONTRIBUTIONS_ADDITIONNELLES_REGULARIZATION,
