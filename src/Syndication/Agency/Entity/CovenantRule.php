...
class CovenantRule
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KLS\Syndication\Agency\Entity\Covenant", inversedBy="covenantRules")
    ...
    /**
     * @ORM\Embedded(class="KLS\Syndication\Agency\Entity\Embeddable\Inequality")
     *
     * @Assert\NotBlank
     * @Assert\Valid
     *
