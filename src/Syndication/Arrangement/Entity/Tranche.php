 ...
 *
 * @Gedmo\Loggable(logEntryClass="KLS\Syndication\Arrangement\Entity\Versioned\VersionedTranche")
 *
...
class Tranche
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KLS\Syndication\Arrangement\Entity\Project", inversedBy="tranches")
     ...
     *
     * @ORM\OneToMany(targetEntity="KLS\Syndication\Arrangement\Entity\ProjectParticipationTranche", mappedBy="tranche", cascade={"persist"}, orphanRemoval=true, fetch="LAZY")
     *
     * @Groups({"tranche:read"})
     */
