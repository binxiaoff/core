                    ...
                    foreach ($projectData->getReminders($iStatus, $iDaysSincePreviousReminder, $iReminderIndex - 1) as $iProjectId) {
                        try {
                            ...
                            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                ...
                                if (in_array($iStatus, [ProjectsStatus::STATUS_REQUESTED, ProjectsStatus::STATUS_REVIEW])) {
                                    $oCompletenessDate        = $projectStatusHistory->getDateProjectStatus($project->getIdProject(), ProjectsStatus::STATUS_REQUESTED, true);
