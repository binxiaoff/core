...
{
    public const ATTACHMENT_TYPE_TO_VALIDATE = [
    ...
    private function handleGreenPointResponse($response, Attachment $attachment): void
    {
        ...
        if (
            AttachmentType::RIB === $attachment->getType()->getId()
    ...
    {
        if (AttachmentType::JUSTIFICATIF_DOMICILE === $attachment->getType()->getId()
            && GreenpointAttachment::STATUS_VALIDATION_VALID === $greenPointAttachment->getValidationStatus()) {
