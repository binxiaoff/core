...
namespace Unilend\Service\Product\Validator;

use Doctrine\ORM\EntityManagerInterface;
use Unilend\Entity\{Clients, Product, ProductAttributeType, Projects};
use Unilend\Service\{Product\Checker\ClientChecker, Product\Checker\LenderChecker, Product\Contract\ContractManager, Product\ProductAttributeManager};
