...
final class Version20210211162552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agency_margin_rule (id INT AUTO_INCREMENT NOT NULL, id_covenant INT DEFAULT NULL, public_id VARCHAR(36) NOT NULL, expression_operator VARCHAR(2) NOT NULL, expression_value NUMERIC(5, 4) NOT NULL, expression_max_value NUMERIC(5, 4) DEFAULT NULL, UNIQUE INDEX UNIQ_383340BB5B48B91 (public_id), INDEX IDX_383340BA4306C62 (id_covenant), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE agency_covenant_rule ADD expression_operator VARCHAR(2) NOT NULL, ADD expression_value NUMERIC(5, 4) NOT NULL, ADD expression_max_value NUMERIC(5, 4) DEFAULT NULL, DROP expression, CHANGE year year INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agency_covenant_rule ADD expression VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP expression_operator, DROP expression_value, DROP expression_max_value, CHANGE year year VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
