...
final class Version20210211162552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agency_margin_rule (id INT AUTO_INCREMENT NOT NULL, id_covenant INT DEFAULT NULL, public_id VARCHAR(36) NOT NULL, inequality_operator VARCHAR(2) NOT NULL, inequality_min_value NUMERIC(65, 4) NOT NULL, inequality_max_value NUMERIC(65, 4) DEFAULT NULL, UNIQUE INDEX UNIQ_383340BB5B48B91 (public_id), INDEX IDX_383340BA4306C62 (id_covenant), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE agency_covenant_rule ADD inequality_operator VARCHAR(2) NOT NULL, ADD inequality_min_value NUMERIC(65, 4) NOT NULL, ADD inequality_max_value NUMERIC(65, 4) DEFAULT NULL, DROP expression, CHANGE year year INT NOT NULL');
    }
