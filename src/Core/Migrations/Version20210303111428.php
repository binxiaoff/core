...
final class Version20210303111428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE credit_guaranty_eligibility_criteria (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, category VARCHAR(100) NOT NULL, type VARCHAR(20) NOT NULL, target_property_access_path VARCHAR(255) NOT NULL, comparable TINYINT(1) NOT NULL, unit VARCHAR(20) DEFAULT NULL, public_id VARCHAR(36) NOT NULL, UNIQUE INDEX UNIQ_F91B38B0B5B48B91 (public_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE credit_guaranty_program_choice_option (id INT AUTO_INCREMENT NOT NULL, id_program INT NOT NULL, description TEXT NOT NULL, target_property_access_path VARCHAR(100) NOT NULL, public_id VARCHAR(36) NOT NULL, updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', added DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_10BA4269B5B48B91 (public_id), INDEX IDX_10BA42694C70DEF4 (id_program), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE credit_guaranty_program_eligibility (id INT AUTO_INCREMENT NOT NULL, id_program INT NOT NULL, id_eligibility_criteria INT NOT NULL, public_id VARCHAR(36) NOT NULL, updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', added DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_E17147BBB5B48B91 (public_id), INDEX IDX_E17147BB4C70DEF4 (id_program), INDEX IDX_E17147BBF79B4C9A (id_eligibility_criteria), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE credit_guaranty_program_eligibility_configuration (id INT AUTO_INCREMENT NOT NULL, id_program_eligibility INT NOT NULL, id_program_choice_option INT DEFAULT NULL, value VARCHAR(100) DEFAULT NULL, eligible TINYINT(1) NOT NULL, public_id VARCHAR(36) NOT NULL, updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', added DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_F485534DB5B48B91 (public_id), INDEX IDX_F485534DBA8D5FB3 (id_program_eligibility), INDEX IDX_F485534DCB0F0BCB (id_program_choice_option), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
INSERT INTO credit_guaranty_eligibility_criteria (public_id, name, category, type, target_property_access_path, comparable, unit) VALUES
