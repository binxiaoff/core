...
final class Version20210216152419 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE agency_term_answer (id INT AUTO_INCREMENT NOT NULL, id_term INT DEFAULT NULL, id_document INT DEFAULT NULL, valid TINYINT(1) DEFAULT NULL, validated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', borrower_comment VARCHAR(255) DEFAULT NULL, agent_comment VARCHAR(255) DEFAULT NULL, public_id VARCHAR(36) NOT NULL, added DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_19E4CF9B5B48B91 (public_id), INDEX IDX_19E4CF92E2FFB8F (id_term), INDEX IDX_19E4CF988B266E3 (id_document), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
