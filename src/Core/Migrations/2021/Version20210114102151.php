...
final class Version20210114102151 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agency_project DROP id_market_segment, DROP risk_group_name, DROP internal_rating_score, DROP title, DROP funding_specificity, DROP closing_date, DROP end_of_contract_date, DROP description, DROP global_funding_money_amount, DROP global_funding_money_currency');
