...
final class Version20210524165319 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO credit_guaranty_field (public_id, field_alias, category, type, target_property_access_path, comparable, unit, predefined_items) VALUES ('c15555ab-289a-46d5-8a0c-d4e0e8b8e0d6', 'funding_object_amount', 'project', 'other', '', 1, 'money', NULL)");
