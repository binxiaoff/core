...
/**
 * @ORM\Table(name="translations", uniqueConstraints={
 *     @ORM\UniqueConstraint(name="unq_translation", columns={"locale", "section", "name"})}, indexes={@ORM\Index(name="section", columns={"section"})
 * })
 * @ORM\Entity
