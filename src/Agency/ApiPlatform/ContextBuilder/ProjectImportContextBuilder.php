...
namespace Unilend\Agency\ApiPlatform\ContextBuilder;
...
class ProjectImportContextBuilder implements SerializerContextBuilderInterface
{
    ...
    public function createFromRequest(Request $request, bool $normalization, array $extractedAttributes = null): array
    {
        ...
        if (
            ...
            if ($arrangementProject && $this->security->isGranted(ProjectVoter::ATTRIBUTE_VIEW, $arrangementProject)) {
                ...
                $agencyProject->setSourcePublicId($arrangementProjectPublicId);
