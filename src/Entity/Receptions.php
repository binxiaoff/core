...
class Receptions
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\SepaRejectionReason")
     * @ORM\JoinColumns({
     ...
     * @var Receptions
     *
     * @ORM\OneToOne(targetEntity="Unilend\Entity\Receptions")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Unilend\Entity\ProjectRepaymentTask", mappedBy="idWireTransferIn")
     */
