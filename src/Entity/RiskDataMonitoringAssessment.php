...
class RiskDataMonitoringAssessment
{
    ...
    /**
     * @var \Unilend\Entity\RiskDataMonitoringCallLog
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\RiskDataMonitoringCallLog")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Unilend\Entity\RiskDataMonitoringType
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\RiskDataMonitoringType")
     * @ORM\JoinColumns({
