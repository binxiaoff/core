 ...
 * @ORM\Entity(repositoryClass="Unilend\Repository\PartnerRepository")
 */
class Partner
{
     ...
     * @var PartnerType
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\PartnerType")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Unilend\Entity\PartnerProjectAttachment", mappedBy="idPartner")
     ...
     *
     * @ORM\OneToMany(targetEntity="Unilend\Entity\PartnerThirdParty", mappedBy="idPartner")
     */
     ...
     * @var PartnerProduct[]
     *
     * @ORM\OneToMany(targetEntity="Unilend\Entity\PartnerProduct", mappedBy="idPartner")
     */
