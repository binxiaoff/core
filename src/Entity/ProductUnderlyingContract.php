...
class ProductUnderlyingContract
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\Product", inversedBy="productContract")
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\UnderlyingContract", inversedBy="productContract")
