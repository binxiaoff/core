...
class CompanyBalanceType
{
    ...
    /**
     * @var \Unilend\Entity\CompanyTaxFormType
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\CompanyTaxFormType")
     * @ORM\JoinColumns({
     ...
     *
     * @param \Unilend\Entity\CompanyTaxFormType $idCompanyTaxFormType
     *
     * @return CompanyBalanceType
     */
    public function setIdCompanyTaxFormType(\Unilend\Entity\CompanyTaxFormType $idCompanyTaxFormType = null)
    {
     ...
     *
     * @return \Unilend\Entity\CompanyTaxFormType
     */
