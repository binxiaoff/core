 ...
 * @ORM\Entity(repositoryClass="Unilend\Repository\WsCallHistoryRepository")
...
class WsCallHistory
{
    ...
    /**
     * @var \Unilend\Entity\WsExternalResource
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\WsExternalResource")
     * @ORM\JoinColumns({
