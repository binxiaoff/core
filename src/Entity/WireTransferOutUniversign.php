...
class WireTransferOutUniversign implements UniversignEntityInterface
{
     ...
     *
     * @ORM\OneToOne(targetEntity="Unilend\Entity\Virements", inversedBy="universign")
     * @ORM\JoinColumns({
     ...
     * @return WireTransferOutUniversign
     */
    public function setIdWireTransferOut(\Unilend\Entity\Virements $idWireTransferOut = null)
    {
