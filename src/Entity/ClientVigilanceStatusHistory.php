 ...
 * @ORM\Entity(repositoryClass="Unilend\Repository\ClientVigilanceStatusHistoryRepository")
...
class ClientVigilanceStatusHistory
{
    ...
    /**
     * @var \Unilend\Entity\ClientAtypicalOperation
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\ClientAtypicalOperation")
     * @ORM\JoinColumns({
