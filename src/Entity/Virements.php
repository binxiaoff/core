 ...
 * @ORM\Entity(repositoryClass="Unilend\Repository\WireTransferOutRepository")
...
class Virements
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\Projects", inversedBy="wireTransferOuts")
     * @ORM\JoinColumns({
     ...
     * @var string
     *
     * @ORM\Column(name="motif", type="string", length=150)
     */
    private $motif;
     ...
     * @var BankAccount
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\BankAccount")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToOne(targetEntity="Unilend\Entity\WireTransferOutUniversign", mappedBy="idWireTransferOut")
     */
    private $universign;
