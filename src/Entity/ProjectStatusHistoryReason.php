 ...
 * })
 * @ORM\Entity(repositoryClass="Unilend\Repository\ProjectStatusHistoryReasonRepository")
...
class ProjectStatusHistoryReason
{
    ...
    /**
     * @var \Unilend\Entity\ProjectAbandonReason
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\ProjectAbandonReason")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Unilend\Entity\ProjectsStatusHistory
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\ProjectsStatusHistory")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Unilend\Entity\ProjectRejectionReason
     *
     * @ORM\ManyToOne(targetEntity="Unilend\Entity\ProjectRejectionReason")
     * @ORM\JoinColumns({
