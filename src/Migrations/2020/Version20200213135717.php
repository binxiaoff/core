...
final class Version20200213135717 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company RENAME INDEX idx_4fbf094f91c00f TO IDX_8244AA3A91C00F');
        $this->addSql('ALTER TABLE company RENAME INDEX uniq_4fbf094f17d2fe0d TO UNIQ_8244AA3A17D2FE0D');
        $this->addSql('ALTER TABLE company RENAME INDEX uniq_4fbf094f41af0274 TO UNIQ_8244AA3A41AF0274');
        $this->addSql('ALTER TABLE company RENAME INDEX uniq_4fbf094fb5b48b91 TO UNIQ_8244AA3AB5B48B91');
        $this->addSql('ALTER TABLE company RENAME INDEX uniq_4fbf094fda33cdfb TO UNIQ_8244AA3ADA33CDFB');
    }
}
