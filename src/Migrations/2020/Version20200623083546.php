...
final class Version20200623083546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE project SET id_nda = NULL WHERE NOT EXISTS( SELECT 1 FROM file WHERE file.id = id_nda)');
        ...
        $this->addSql('UPDATE project_participation_contact SET id_accepted_nda_version = NULL WHERE NOT EXISTS( SELECT 1 FROM file_version WHERE file_version.id = id_accepted_nda_version)');
