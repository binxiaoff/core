...
final class Version20200611130530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE project SET target_arranger_participation_money_amount = NULL WHERE target_arranger_participation_money_amount = ''");
        $this->addSql("UPDATE project SET arrangement_commission_money_currency = NULL WHERE arrangement_commission_money_currency = ''");
        $this->addSql("UPDATE project SET arrangement_commission_money_amount = NULL WHERE arrangement_commission_money_amount = ''");
    }
