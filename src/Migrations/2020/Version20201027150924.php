...
final class Version20201027150924 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE invitation_reply_version (id INT AUTO_INCREMENT NOT NULL, id_project_participation_tranche INT NOT NULL, added_by INT NOT NULL, invitation_reply_added DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', invitation_reply_money_amount NUMERIC(15, 2) DEFAULT NULL, invitation_reply_money_currency VARCHAR(3) DEFAULT NULL, INDEX IDX_AB14FEDDF263895D (id_project_participation_tranche), INDEX IDX_AB14FEDD699B6BAF (added_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
