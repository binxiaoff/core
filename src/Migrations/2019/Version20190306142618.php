...
final class Version20190306142618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bids ADD rate_type VARCHAR(20) NOT NULL AFTER amount, ADD rate_margin NUMERIC(4, 2) NOT NULL AFTER rate_type, DROP rate, CHANGE id_lender_account id_wallet INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE loans ADD rate_type VARCHAR(20) NOT NULL AFTER amount, ADD rate_margin NUMERIC(4, 2) NOT NULL AFTER rate_type, DROP rate, CHANGE id_lender id_wallet INT NOT NULL');
