...
final class Version20190509152136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT IGNORE INTO translations (locale, section, name, translation, added) VALUES ("fr_FR", "percent-fee-form", "delete-row", "Supprimer les frais", NOW())');
        $this->addSql('INSERT IGNORE INTO translations (locale, section, name, translation, added) VALUES ("fr_FR", "tranche-form", "delete-row", "Supprimer la tranche", NOW())');
