...
final class Version20190830094708 extends ContainerAwareMigration
{
    use FlushTranslationCacheTrait;

    public function getDescription(): string
    {
        return 'CALS-287 Add translations for mail when update identity';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('INSERT INTO translations (locale, section, name, translation, added) VALUES (\'fr_FR\', \'mail-title\', \'identity-updated\', \'Informations personnelles modifiées\', NOW())');
...
[EMV DYN]changeFields[EMV /DYN]
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td class="cta" align="center">
            
            <a href="[EMV DYN]profileUrl[EMV /DYN]" class="btn-primary">Consulter mon profil</a>
        </td>
    </tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0;">
    <tr>
        <td class="cta" align="center" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; text-align: center; padding-top: 18px; padding-bottom: 18px;">
            ...
            <a href="[EMV DYN]profileUrl[EMV /DYN]" class="btn-primary" style="font-weight: normal; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; mso-hide: all; display: inline-block; border-radius: 4px; border-width: 2px; border-style: solid; min-width: 120px; padding-left: 30px; padding-right: 30px; padding-top: 11px; padding-bottom: 11px; font-size: 18px; text-decoration: none; border-color: #2bc9af; background: #2bc9af; color: #fff;">Consulter mon profil</a>
        </td>
    </tr>
</table>
</td>
...
<!-- END TEMPLATE -->
    ...
    {
        $this->addSql('DELETE FROM translations WHERE section = "mail-title" AND name = "identity-updated"');
        $this->addSql('DELETE FROM mail_templates WHERE type = "identity-updated"');
        $this->addSql('DELETE FROM translations WHERE section = "mail-identity-updated"');
    }
}
