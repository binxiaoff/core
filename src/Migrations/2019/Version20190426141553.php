...
final class Version20190426141553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_status_history (id INT AUTO_INCREMENT NOT NULL, id_project INT NOT NULL, status SMALLINT NOT NULL, added DATETIME NOT NULL, addedBy INT NOT NULL, INDEX IDX_C6DD336CF12E799E (id_project), INDEX IDX_C6DD336CE7CA843C (addedBy), INDEX IDX_C6DD336C7B00651C (status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE project_status_history ADD CONSTRAINT FK_C6DD336CE7CA843C FOREIGN KEY (addedBy) REFERENCES clients (id_client)');
