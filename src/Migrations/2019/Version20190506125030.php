    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            ...
            VALUES
                   ...
                   ('fr_FR', 'project-form', 'title-label', 'Titre', NOW()),
                   ('fr_FR', 'project-form', 'borrower-company-label', 'Contrepartie emprunteuse', NOW()),
                   ('fr_FR', 'project-form', 'market-segment-label', 'Marché', NOW()),
                   ('fr_FR', 'project-form', 'replay-deadline-label', 'Date butoir de réponse', NOW()),
                   ('fr_FR', 'project-form', 'expected-closing-date-label', 'Date de closing envisagée', NOW()),
                   ('fr_FR', 'project-form', 'description-label', 'Description du projet', NOW()),
                   ('fr_FR', 'project-form', 'arranger-label', 'Arrangeur', NOW()),
                   ('fr_FR', 'project-form', 'run-label', 'RUN', NOW()),
