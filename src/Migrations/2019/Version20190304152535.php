...
final class Version20190304152535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE project_company_role (id INT AUTO_INCREMENT NOT NULL, id_project INT NOT NULL, id_company INT NOT NULL, added DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime)\', roles JSON NOT NULL, INDEX IDX_3EA374E7F12E799E (id_project), INDEX IDX_3EA374E79122A03F (id_company), UNIQUE INDEX UNIQ_3EA374E7F12E799E9122A03F (id_project, id_company), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE project_company_role ADD CONSTRAINT FK_3EA374E7F12E799E FOREIGN KEY (id_project) REFERENCES projects (id_project)');
        $this->addSql('ALTER TABLE project_company_role ADD CONSTRAINT FK_3EA374E79122A03F FOREIGN KEY (id_company) REFERENCES companies (id_company)');
    }
