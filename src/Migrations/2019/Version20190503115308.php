...
final class Version20190503115308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attachment DROP FOREIGN KEY FK_795FD9BBE173B1B8');
        ...
        $this->addSql('ALTER TABLE attachment RENAME INDEX id_client TO IDX_795FD9BB699B6BAF');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attachment RENAME INDEX IDX_795FD9BB699B6BAF TO id_client');
