...
final class Version20190708122648 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'CALS-239 Clean tree and acceptations_legal_docs tables';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX id_tree ON tree');
        $this->addSql('ALTER TABLE tree DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE tree CHANGE added added DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE tree ADD PRIMARY KEY (id_tree)');
        $this->addSql('ALTER TABLE acceptations_legal_docs ADD CONSTRAINT FK_F1D2E4327F757BBC FOREIGN KEY (id_legal_doc) REFERENCES tree (id_tree)');
        $this->addSql('CREATE INDEX IDX_F1D2E4327F757BBC ON acceptations_legal_docs (id_legal_doc)');
        $this->addSql('ALTER TABLE acceptations_legal_docs RENAME INDEX id_client TO IDX_F1D2E432E173B1B8');
...
<p style="margin-top: 18px; margin-bottom: 18px; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #302a32; font-size: 16px; line-height: 27px; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">Vous venez de signer les Conditions Générales de la plateforme Crédit Agricole Lending Services. Vous trouverez ci-joint la version PDF de ces Conditions Générales.</p>
<p style="margin-top: 18px; margin-bottom: 18px; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #302a32; font-size: 16px; line-height: 27px; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;"></p>
<p style="margin-top: 18px; margin-bottom: 18px; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #302a32; font-size: 16px; line-height: 27px; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">À bientôt sur Crédit Agricole Lending Service</p>
</td>
</tr>
...
EMAIL
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acceptations_legal_docs DROP FOREIGN KEY FK_F1D2E4327F757BBC');
        $this->addSql('DROP INDEX IDX_F1D2E4327F757BBC ON acceptations_legal_docs');
        $this->addSql('ALTER TABLE acceptations_legal_docs RENAME INDEX idx_f1d2e432e173b1b8 TO id_client');
        $this->addSql('ALTER TABLE tree DROP PRIMARY KEY');
