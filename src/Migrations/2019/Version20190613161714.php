...
final class Version20190613161714 extends ContainerAwareMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO translations (locale, section, name, translation, added) VALUES (\'fr_FR\', \'lending-rate-form\', \'margin-required\', \'Merci de saisir un Taux\', NOW())');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DELETE FROM translations WHERE section = \'lending-rate-form\' AND name = \'margin-required\'');
    }
}
