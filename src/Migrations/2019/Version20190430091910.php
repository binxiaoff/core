...
final class Version20190430091910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD foncaris_guarantee SMALLINT DEFAULT NULL AFTER title');
    }
