...
class ProgramBorrowerTypeAllocationExtension implements QueryCollectionExtensionInterface
{
    ...
    {
        if (ProgramBorrowerTypeAllocation::class !== $resourceClass || $this->security->isGranted(User::ROLE_ADMIN)) {
            return;
        }
