...
class FieldFixtures extends AbstractSQLFixtures
{
     ...
     * to create in Borrower :                  juridical_person
     * to create in BorrowerBusinessActivity :  siren, activity_start_date, naf_code_company, low_density_medical_area_exercise
     * to create in FinancingObject :           loan_deferral
     */
    protected static string $sql = <<<'INSERT_FIELDS'
        ...
        ('f6ea8c30-48d1-4852-9c4a-5e1298f7f902', 'siret', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::siret', 0, NULL, NULL),
        ('932afe50-582a-462c-b5cc-16cdd3f09c07', 'activity_country', 'activity', 'list', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::address::country', 0, NULL, '["FR"]'),
        ('d61a4e71-4438-46f1-b1a5-376f98566c06', 'activity_start_date', 'activity', 'other', '', 0, NULL, NULL),
        ('6c067265-5ff5-49f4-84f0-e511a4a7d42e', 'employees_number', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::employeesNumber', 1, 'person', NULL),
        ('9865fb18-ba90-42ce-9455-e7c508acddd9', 'last_year_turnover', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::lastYearTurnover', 1, 'money', NULL),
        ('a2e2cbad-75d3-42a4-83d9-aef63da4360e', '5_years_average_turnover', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::fiveYearsAverageTurnover', 1, 'money', NULL),
        ('7cccbd98-6b99-4425-8f29-83a04027740c', 'naf_code_company', 'activity', 'list', '', 0, NULL, NULL),
        ('938c689e-bddb-42b9-b84a-a00b18523e4f', 'total_assets', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::totalAssets', 1, 'money', NULL),
        ('5e6b31a1-1007-4e8d-a1ce-9a38e62280b9', 'grant_amount', 'activity', 'other', 'Unilend\\CreditGuaranty\\Entity\\BorrowerBusinessActivity::grant', 1, 'money', NULL),
