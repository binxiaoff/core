...
class FieldFixtures extends AbstractSQLFixtures
{
    protected static string $sql = <<<'INSERT_FIELDS'
        ...
        ('a2f8bca2-0662-4569-a334-57bd00972dcc', 'naf_code_project', 'project', 'list', '', 0, NULL, NULL),
        ('8cb4b512-fa4c-4638-9a28-11d16b450459', 'funding_object', 'project', 'list', '', 0, NULL, NULL),
        ('a82acccf-565e-4a97-9ed4-ce8aaf280244', 'funding_object_amount', 'project', 'other', '', 1, 'money', NULL),
