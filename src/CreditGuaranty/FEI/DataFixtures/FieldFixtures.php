...
class FieldFixtures extends AbstractSQLFixtures
{
    protected static string $sql = <<<'INSERT_FIELDS'
        INSERT INTO credit_guaranty_field (
            public_id, category, type, field_alias, reservation_property_name, property_path, property_type, object_class, comparable, unit, predefined_items
        ) VALUES
        (
            '4bd9fc81-aaaa-4753-913e-86c6b193fd85', 'profile', 'other',
            'beneficiary_name', 'borrower', 'beneficiaryName', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '46c2d1b3-61fa-4d2f-a3f3-0336feecd2e2', 'profile', 'list',
            'borrower_type', 'borrower', 'borrowerType', 'ProgramChoiceOption',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'df8c4d9b-6978-4656-899c-0f083c0f22f2', 'profile', 'bool',
            'young_farmer', 'borrower', 'youngFarmer', 'bool',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '3e2201f1-493f-475d-b84f-ee44e9065ea2', 'profile', 'bool',
            'creation_in_progress', 'borrower', 'creationInProgress', 'bool',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '0393c13d-1511-4d60-975e-ead448ed5d13', 'profile', 'bool',
            'subsidiary', 'borrower', 'subsidiary', 'bool',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '56d4b239-8b5a-41f0-9e65-4ced292b0c0c', 'profile', 'other',
            'company_name', 'borrower', 'companyName', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '7518eade-0825-4464-8b07-c372fd69300c', 'profile', 'other',
            'activity_street', 'borrower', 'addressStreet', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'ffa27a62-e831-4d9f-bdda-d7dbdd5ab57f', 'profile', 'other',
            'activity_post_code', 'borrower', 'addressPostCode', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'e5c18fa8-adb2-4123-ad49-d7c6b95eae70', 'profile', 'other',
            'activity_city', 'borrower', 'addressCity', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'c4876798-0ed5-4808-9ef9-c1810b158c4f', 'profile', 'other',
            'activity_department', 'borrower', 'addressDepartment', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '932afe50-582a-462c-b5cc-16cdd3f09c07', 'profile', 'list',
            'activity_country', 'borrower', 'addressCountry', 'ProgramChoiceOption',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'd61a4e71-4438-46f1-b1a5-376f98566c06', 'profile', 'other',
            'activity_start_date', 'borrower', 'activityStartDate', 'DateTimeImmutable',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'f6ea8c30-48d1-4852-9c4a-5e1298f7f902', 'profile', 'other',
            'siret', 'borrower', 'siret', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            '093a2142-ab5d-4b57-afb0-e8749131740b', 'profile', 'other',
            'tax_number', 'borrower', 'taxNumber', 'string',
            'KLS\\CreditGuaranty\\FEI\\Entity\\Borrower', 0, NULL, NULL
        ),
        (
            'eef6e5ac-8de6-4084-a06b-dd2974141d94', 'profile', 'list',
        ...
        (
            '61ad5da2-1ae1-4c0b-b3bd-ce42fc0bea3b', 'loan', 'list',
